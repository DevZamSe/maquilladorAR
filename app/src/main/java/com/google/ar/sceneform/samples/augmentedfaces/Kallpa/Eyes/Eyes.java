package com.google.ar.sceneform.samples.augmentedfaces.Kallpa.Eyes;
...
public class Eyes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arFragment = (AugmentedFacesActivity.FaceArFragment) getSupportFragmentManager().findFragmentById(R.id.face_fragment);
        ...
        rostro.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Eyes.this, AugmentedFacesActivity.class);
